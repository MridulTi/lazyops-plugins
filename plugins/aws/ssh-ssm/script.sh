...
# preferring SSH_PREFERRED_KEY when set, then other keys. Tries users ec2-user,
...
# Prefer SSH_PREFERRED_KEY when set; otherwise use keys in directory order.
PREFERRED_KEY="${SSH_PREFERRED_KEY:-}"
